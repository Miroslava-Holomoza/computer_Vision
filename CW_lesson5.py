...
for cnt in contours:
    ...
    if area > 200:
        ...
        cv2.putText(img_copy, f'S: {area}, P:{perimeter}', (x, y + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (0, 0, 255))
        cv2.putText(img_copy, f'AR:{aspect_ratio}, C:{compactness}', (x, y + 25), cv2.FONT_HERSHEY_SIMPLEX, 0.3, (0, 0, 255))
        cv2.putText(img_copy, f'Shape:{shape}', (x, y + 35), cv2.FONT_HERSHEY_SIMPLEX, 0.3,
                    (0, 0, 255))

cv2.imshow('men', img)
cv2.imshow('men copy', img_copy)
